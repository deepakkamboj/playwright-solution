...
import {
  ...
  Page,
  ElementHandle,
  Request as IBrowserRequest,
  Route as IBrowserRoute
} from 'playwright';
 ...
 */
export type RunType = 'pr' | 'nightly' | 'runner';
...
export { BrowserContext, ElementHandle, IBrowserRequest, IBrowserRoute, Page };
